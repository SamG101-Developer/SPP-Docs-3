...
| Operator | Name                      | Description                                                                    | Class                  |
|----------|---------------------------|--------------------------------------------------------------------------------|------------------------|
...
| `\|`     | `std.ops.BOr`  | `fun b_or(self, that: Rhs) -> Out`  |
| `^`      | `std.ops.BXor` | `fun b_xor(self, that: Rhs) -> Out` |
...
| `&`      | `std.ops.BAnd` | `fun b_and(self, that: Rhs) -> Out` |
...
- Only the `(...)` operator can be overloaded.
...
- The expressions `loop some_long_function_name().attrribute1.attribute2.not()` is clearer than 
  `loop !some_long_function_name().attribute1.attribute2`.
